...
# coins by the time you arrive so you can pay the deposit on your
# room.
#
...
Input = open("01.in").read.scan(/\d+/).map(&:to_i)

puts Input.combination(2).find {|a,b| a+b == 2020 }.reduce(:*)
...
puts Input.combination(3).find {|a,b,c| a+b+c == 2020 }.reduce(:*)
