...
#   public keys (your puzzle input) to the other device.  Now, the
#   card has the door's public key, and the door has the card's public
#   key.  Because you can eavesdrop on the signal, you have both
...
# --------------------
#
# Diffie-Hellman key exchange.  M=20201227 is prime and 7 is a
# primitive root of M.  In mathematical terms, we're given public keys
# 7^c (mod M) and 7^d (mod M).  We work out what c must equal, then
# compute (7^d)^c, the encryption key.

PK1, PK2 = open("25.in").read.split.map(&:to_i)
M = 20201227 # modulus

e = 1 # exponent corresponding to PK1
v = 7
while v != PK1
  v = (v*7)%M
  e += 1
...
# -- Part Two ---
#
# The light turns green and the door unlocks.  As you collapse onto
# the bed in your room, your pager goes off!
#
